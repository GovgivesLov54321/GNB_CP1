# GNB - 1st - 🔨 Factorial Calculator

#Make a function that multiplies the number
def multiply(a, b):
    return num_choice * num_choice

#Make list of the numbers that they can use named "numbers"
